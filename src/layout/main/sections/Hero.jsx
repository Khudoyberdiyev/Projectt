    ...
    <section className="container mt-[100px]">
      <div className="text-center items-center justify-center ">
        ...
        <div className="pt-[60px]">
          <button className="py-[15px] items-center text-center px-[34px] ml-[20px] text-lg font-normal rounded-lg bg-none hover:bg-[#FF9500] hover:text-white">
            Explore Courses
          </button>
          <button className="py-[15px] items-center text-center px-[34px] ml-[20px] text-lg font-normal rounded-lg bg-none hover:bg-[#FF9500] hover:text-white">
            View Pricing
        ...
        <div className="flex justify-center items-center rounded-lg bg-white mt-[100px] p-[30px] ">
          <span className="border-r-2 border-slate-100">
            <Zapier />
          </span>
          <span className="border-r-2 border-slate-100">
            <Spotify />
